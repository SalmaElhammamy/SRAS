...
class Config:
    ...
    frames = multiprocessing.Manager().dict(
        {driver: None for driver in camera_drivers})
    inference_frames = multiprocessing.Manager().dict(
        {driver: None for driver in camera_drivers})
...
if __name__ == '__main__':
    consumers = [ConsumerProcess(driver) for driver in Config.camera_drivers]
    inference_consumers = [ConsumerProcess(driver, WorkerType.WITH_INFERENCE)
